...
public class UploadAudios {
    ...
    public static void main(String[] args) {
        String audioId = "4";
        String audioTitle = "my_song_1";
        String dataPath = "C:/Users/10660893/ACRTool/my_song_1.mp3.db.lo";
        String dataType = "fingerprint"; // audio & fingerprint
        String bucketName = "MusicBucket";
        String accessKey = "98b46ea5d26cfd61";
